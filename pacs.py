...
def pacs(args, dataset_path, model_helpers_root_path, do_train=False, do_stats=False, do_finetuning=False):
    ...
    if do_train:
        ...
        train(model, dataset_path, criterion, optimizer, save_path, epochs=40, best_acc=False)
    ...
    if do_finetuning:
        dataset_path = 'path_to_s'
        valid_dataset_path = 'path_to_pac'
