...
def acsp(args, dataset_path, model_helpers_root_path, do_train=False, do_stats=False, do_finetuning=False):
    ...
    if do_finetuning:
        dataset_path = 'path_to_p'
        valid_dataset_path = 'path_to_acs'
